...
const HomePageQueryOpts = {
  attributes: ['id', 'title', 'slug', 'newFeaturedImage', 'productType', 'newThumbWidth', 'newThumbHeight', 'parentCategoryId', 'parentCategoryName', 'parentCategoryUrl', 'createdTime', 'popularIndex', 'homePagePosition', 'isPro', 'proParentCategoryName', 'proParentCategorySlug', 'wordpressDemoUrl', 'proPlus'],
  where: {
